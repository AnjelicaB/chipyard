...
if run_step "6"; then
    ...
    # add firesim's conda env to chipyard's env.sh with --stack.
    # don't directly invoke firesim's sourceme because it's expected that users will source
    # that themselves.
    replace_content env.sh build-setup-firesim-conda "# line auto-generated by $0
    conda activate --stack $CYDIR/sims/firesim/.conda-env"
